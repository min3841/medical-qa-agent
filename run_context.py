...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="PubMedQA context 제공 평가"
    )
...
def main() -> None:
    ...
    for index, sample in enumerate(
        tqdm(dataset, desc="Context 제공 평가"),
        start=1,
    ):
        ...
        response = client.responses.create(
            ...
            instructions=(
               ...
               "If the context is insufficient, answer maybe. "
    ...
    output_path = (
        results_dir
        / f"context_{args.num_samples}.csv"
    )
